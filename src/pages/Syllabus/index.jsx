    ...
    return (
        <div class="container-fluid" id="home">
            <div class="row align-items-center">
                <div class="col-12 mt-5 p-5 col-md-7 text-white text-left">
                    <div class="container">
                ...
                <div class="position-fixed d-none d-md-block" style={{ right: '0', top: '0' }}>
                    <img style={{ width: '40vw' }} class="img-fluid d-none d-md-block" src="images/skyline-3.jpeg" />
                    <img class="img-fluid d-md-none" src="images/skyline-3.jpeg" alt="" />
                </div>
            </div>
        </div>
    );
